<html>
    <head>
        ...
        <title>The Dev's Story - Games - Mathoria: The Last Solution</title>
    </head>
        ...
        <div class="container contentpage contentwidth">
            <div class="item">
                <ol class="breadcrumb">
                    ...
                    <li><a href="../games/mathoriathelastsolution.php">Mathoria: The Last Solution</a></li>
                </ol>
                <div class="devbanner mathoria"></div>
                <?php include "../page-headers/page-header_mathoriathelastsolution.php";
                ?>
