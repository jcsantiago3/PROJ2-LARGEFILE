<html>
    <head>
        ...
        <title>The Dev's Story - Games - APretentious Game</title>
    </head>
        ...
        <div class="container contentpage contentwidth">
            <div class="item">
                <ol class="breadcrumb">
                    ...
                    <li><a href="../games/pretentiousgame.php">Pretentious Game</a></li>
                </ol>
                <div class="devbanner pretentiousgame"></div>
                <?php include "../page-headers/page-header_pretentiousgame.php";
                ?>
                <div class="panel panel-default">
                    ...
                    <div class="user_reviews_summary_bar">
                            <div class="summary_section">
                                ...
                                <span class="game_review_summary positive" data-tooltip-text="76% of the 60 user reviews for this game are positive."><strong>Mostly Positive</strong></span>
