<html>
    <head>
        ...
        <title>The Dev's Story - Games - Brushstrokesr</title>
    </head>
        ...
        <div class="container contentpage contentwidth">
            <div class="item">
                <ol class="breadcrumb">
                    ...
                    <li><a href="../games/brushstrokes.php">Brushstrokes</a></li>
                </ol>
                <div class="devbanner brushstrokes"></div>
                <?php include "../page-headers/page-header_brushstrokes.php";
                ?>
