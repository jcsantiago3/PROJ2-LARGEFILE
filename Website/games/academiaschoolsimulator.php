<html>
    <head>
        ...
        <title>The Dev's Story - Games - Academia School Simulator</title>
    </head>
                    ...
                    <!--STEAM USER REVIEWS-->
                        <div class="user_reviews_summary_bar">
                            <div class="summary_section">
                                ...
                                <span class="game_review_summary positive" data-tooltip-text="77% of the 241 user reviews for this game are positive."><strong>Mostly Positive</strong></span>
