<html>
    <head>
        ...
        <title>The Dev's Story - Games - Dragon Snack</title>
    </head>
        ...
        <div class="container contentpage contentwidth">
            <div class="item">
                <ol class="breadcrumb">
                    ...
                    <li><a href="../games/dragonsnack.php">Dragon Snack</a></li>
                </ol>
                <div class="devbanner dragonsnack"></div>
                <?php include "../page-headers/page-header_dragonsnack.php";
                ?>
