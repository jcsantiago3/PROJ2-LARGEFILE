<html>
    <head>
        ...
        <title>The Dev's Story - Games - Dungeon Souls</title>
    </head>
        ...
        <div class="container contentpage contentwidth">
            <div class="item">
                <ol class="breadcrumb">
                    ...
                    <li><a href="../games/dungeonsouls.php">Warrior Defense</a></li>
                </ol>
                <div class="devbanner dungeonsouls"></div>
                <?php include "../page-headers/page-header_dungeonsouls.php";
                ?>
                    ...
                    <!--STEAM USER REVIEWS-->
                        <div class="user_reviews_summary_bar">
                            <div class="summary_section">
                                ...
                                <span class="game_review_summary positive" data-tooltip-text="82% of the 994 user reviews for this game are positive."><strong>Very Positive</strong></span>
                                <span>(994 reviews)</span>
                            </div>
                        </div>
