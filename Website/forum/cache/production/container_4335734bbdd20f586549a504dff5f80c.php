...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000071e4c28400000000456ed3c7(
...
class phpbbtemplatetwiglexer_0000000071e4c28400000000456ed3c7 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a75d620ee440919330018 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a75d620ee467725241849 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a75d620ee3dd261470530 = array(
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, 'set_environment', array('env' => $env), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        return $this->valueHolder5a75d620ee440919330018->set_environment($env);
    }
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        return $this->valueHolder5a75d620ee440919330018->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        return $this->valueHolder5a75d620ee440919330018->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a75d620ee467725241849 = $initializer;
    }
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__get', array('name' => $name), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        if (isset(self::$publicProperties5a75d620ee3dd261470530[$name])) {
            return $this->valueHolder5a75d620ee440919330018->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a75d620ee440919330018;
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__isset', array('name' => $name), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__unset', array('name' => $name), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;
    ...
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__clone', array(), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        $this->valueHolder5a75d620ee440919330018 = clone $this->valueHolder5a75d620ee440919330018;
    }

    public function __sleep()
    {
        $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, '__sleep', array(), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;

        return array('valueHolder5a75d620ee440919330018');
    }
    ...
    {
        return $this->initializer5a75d620ee467725241849;
    }
    ...
    {
        return $this->initializer5a75d620ee467725241849 && ($this->initializer5a75d620ee467725241849->__invoke($valueHolder5a75d620ee440919330018, $this, 'initializeProxy', array(), $this->initializer5a75d620ee467725241849) || 1) && $this->valueHolder5a75d620ee440919330018 = $valueHolder5a75d620ee440919330018;
    }
    ...
    {
        return null !== $this->valueHolder5a75d620ee440919330018;
    }
    ...
    {
        return $this->valueHolder5a75d620ee440919330018;
    }
