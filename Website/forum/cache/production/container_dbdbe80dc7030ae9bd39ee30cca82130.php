...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001352bfc6000000007749b72f(
...
class phpbbtemplatetwiglexer_000000001352bfc6000000007749b72f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a75d88d85846961322967 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a75d88d8588b907412944 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a75d88d857ca844273189 = array(
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, 'set_environment', array('env' => $env), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        return $this->valueHolder5a75d88d85846961322967->set_environment($env);
    }
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        return $this->valueHolder5a75d88d85846961322967->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        return $this->valueHolder5a75d88d85846961322967->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a75d88d8588b907412944 = $initializer;
    }
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__get', array('name' => $name), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        if (isset(self::$publicProperties5a75d88d857ca844273189[$name])) {
            return $this->valueHolder5a75d88d85846961322967->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a75d88d85846961322967;
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__isset', array('name' => $name), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__unset', array('name' => $name), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;
    ...
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__clone', array(), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        $this->valueHolder5a75d88d85846961322967 = clone $this->valueHolder5a75d88d85846961322967;
    }

    public function __sleep()
    {
        $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, '__sleep', array(), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;

        return array('valueHolder5a75d88d85846961322967');
    }
    ...
    {
        return $this->initializer5a75d88d8588b907412944;
    }
    ...
    {
        return $this->initializer5a75d88d8588b907412944 && ($this->initializer5a75d88d8588b907412944->__invoke($valueHolder5a75d88d85846961322967, $this, 'initializeProxy', array(), $this->initializer5a75d88d8588b907412944) || 1) && $this->valueHolder5a75d88d85846961322967 = $valueHolder5a75d88d85846961322967;
    }
    ...
    {
        return null !== $this->valueHolder5a75d88d85846961322967;
    }
    ...
    {
        return $this->valueHolder5a75d88d85846961322967;
    }
